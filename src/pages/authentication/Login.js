...
export default function Login() {
  ...
  return (
    <RootStyle title="Đăng nhập | VinFlat">
      {/* <AuthLayout>
      ...
      <Container maxWidth="sm">
        <ContentStyle>
          <Stack direction="row" alignItems="center" sx={{ mb: 5 }}>
            <Box sx={{ flexGrow: 1 }}>
              ...
              <Typography sx={{ color: 'text.secondary' }}>
                Vui lòng nhập thông tin tài khoản của bạn dưới đây.
              </Typography>
            </Box>
          ...
          <Alert severity="info" sx={{ mb: 3 }}>
            Dùng <strong>tài khoản</strong> và <strong>mật khẩu</strong> được cấp cho nhân viên VinFlat
          </Alert>
