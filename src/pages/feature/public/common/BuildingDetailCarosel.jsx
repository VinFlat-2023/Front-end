...
export default function BuildingDetailsCarousel({building}) {
  ...
  const imagesLightbox = building?.ImageUrls.map((_image) => _image);
  ...
  const settings2 = {
    ...
    variableWidth: true,
    centerPadding: '0px',
    slidesToShow: building?.ImageUrls.length > 3 ? 3 : building?.ImageUrls.length
  };
    ...
    <RootStyle>
      ...
      <Box
        sx={{
          ...
          ...(building.ImageUrls.length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...(building.ImageUrls.length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...(building.ImageUrls.length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(building.ImageUrls.length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(building.ImageUrls.length >= 5 && { maxWidth: THUMB_SIZE * 6 }),
          ...(building.ImageUrls.length > 2 && {
            position: 'relative',
            '&:before, &:after': {
              top: 0,
              zIndex: 9,
